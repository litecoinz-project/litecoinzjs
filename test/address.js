...
it('MkPrivateKey() should be deterministic', function () {
  var priv = litecoinzjs.address.mkPrivKey(
...
it('PrivateKeyToWIFFormat() should be deterministic', function () {
  var priv = litecoinzjs.address.privKeyToWIF(
    '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c'
  )
...
it('PrivateKeyToPublicKey() should be deterministic', function () {
  var priv = litecoinzjs.address.privKeyToPubKey(
    '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c'
  )
  expect(priv).to.equal(
...
it('PublicKeyToPublicAddress() should be deterministic', function () {
  var addr = litecoinzjs.address.pubKeyToAddr(
    '048a789e0910b6aa314f63d2cc666bd44fa4b71d7397cb5466902dc594c1a0a0d2e4d234528ff87b83f971ab2b12cd2939ff33c7846716827a5b0e8233049d8aad'
  )
  expect(addr).to.equal('znkz4JE6Y4m8xWoo4ryTnpxwBT5F7vFDgNf')

  var addrComp = litecoinzjs.address.pubKeyToAddr(
...
it('mkMultiSigRedeemScript() should be deterministic', function () {
  var redeemScript = litecoinzjs.address.mkMultiSigRedeemScript(
...
it('multiSigRSToAddress() should be deterministic', function () {
  var msAddress = litecoinzjs.address.multiSigRSToAddress('522103519842d08ea56a635bfa8dd617b8e33f0426530d8e201107dd9a6af9493bd4872102d3ac8c0cb7b99a26cd66269a312afe4e0a621579dfe8b33e29c597a32a6165442102696187262f522cf1fa2c30c5cd6853c4a6c51ad5ba418abb4e3898dbc5a93d2e53ae')  
