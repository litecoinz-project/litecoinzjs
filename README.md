# litecoinzjs
Dead simple and easy to use JavaScript based library for litecoinz. Inspired by [pybitcointools](https://github.com/vbuterin/pybitcointools)

# Example usage (Transparent address)
```javascript
var litecoinzjs = require('litecoinzjs')

var priv = litecoinzjs.address.mkPrivKey('chris p. bacon, defender of the guardians')
// 2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c

var privWIF = litecoinzjs.address.privKeyToWIF(priv)
// 5J9mKPd531Tk4A73kKp4iowoi6EvhEp8QSMAVzrZhuzZkdpYbK8

var pubKey = litecoinzjs.address.privKeyToPubKey(priv, true) // generate compressed pubKey
// 038a789e0910b6aa314f63d2cc666bd44fa4b71d7397cb5466902dc594c1a0a0d2

var zAddr = litecoinzjs.address.pubKeyToAddr(pubKey)
...
var txobj = litecoinzjs.transaction.createRawTx(
  [{
...
// litecoinzjs.transaction.serializeTx(txobj)
...
var tx0 = litecoinzjs.transaction.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c', true) // The final argument sets the `compressPubKey` boolean. It is `false` by default.
// litecoinzjs.transaction.serializeTx(tx0)
...
// You can now do litecoinz-cli sendrawtransaction `SERIALIZED_TRANSACTION`
```
...
var privKeys = privKeysWIF.map((x) => litecoinzjs.address.WIFToPrivKey(x))
...
var pubKeys = privKeys.map((x) => litecoinzjs.address.privKeyToPubKey(x, true))
...
var redeemScript = litecoinzjs.address.mkMultiSigRedeemScript(pubKeys, 2, 3)
...
var multiSigAddress = litecoinzjs.address.multiSigRSToAddress(redeemScript)
...
var sig1 = litecoinzjs.transaction.multiSign(txobj, 0, privKeys[0], redeemScript)
...
var sig2 = litecoinzjs.transaction.multiSign(txobj, 0, privKeys[1], redeemScript)
...
// var txBytes = litecoinzjs.transaction.serializeTx(txobj)
// var txObj = litecoinzjs.transaction.deserializeTx(txBytes)

// Apply the signatures to the transaction object
var tx0 = litecoinzjs.transaction.applyMultiSignatures(txobj, 0, [sig1, sig2], redeemScript)

// Serialize the transaction
var serializedTx = litecoinzjs.transaction.serializeTx(tx0)
...
var z_secretKey = litecoinzjs.zaddress.mkZSecretKey('Z pigs likes to snooze. ZZZZ')
// 0c10a61a669bc4a51000c4c74ff58c151912889891089f7bae5e4994a73af7a8

// Spending key (this is what you import into your wallet)
var spendingKey = litecoinzjs.zaddress.zSecretKeyToSpendingKey(z_secretKey)
// SKxtHJsneoLByrwME9Nh4cd4AvYLNK9jJkAnB3AHNW794udD1qpx

// Paying key
var a_pk = litecoinzjs.zaddress.zSecretKeyToPayingKey(z_secretKey)
// 927a3819627247c0dd39102ec5449fc6fc952e242aad08615df9f26718912e27

// Transmission key
var pk_enc = litecoinzjs.zaddress.zSecretKeyToTransmissionKey(z_secretKey)
// 22d666c34ababacf6a9a4a752cc7870b505b64e85638aa45d23ac32992397960

var Zaddress = litecoinzjs.zaddress.mkZAddress(a_pk, pk_enc)
...
git clone https://github.com/litecoinz-project/litecoinzjs.git
cd litecoinzjs
npm install
npm run [dev | build]
```
